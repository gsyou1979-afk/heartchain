    ...
    <div v-if="showPlacementModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-lg w-full max-w-lg max-h-[80vh] flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto px-4 py-4">
          <form @submit.prevent="savePlacement" id="placementForm">
            <div class="space-y-4">
              <div>
        ...
        <!-- 按钮：固定底部不滚动 -->
        <div class="flex-shrink-0 flex gap-3 px-4 py-3 border-t bg-white rounded-b-lg">
          <button type="submit" form="placementForm" class="flex-1 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600">保存</button>
